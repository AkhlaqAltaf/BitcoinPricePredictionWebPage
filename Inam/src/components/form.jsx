    ...
    <div className="form-left">
        <form onSubmit={handleSubmit} action="">
            <div className="form-control" id='form-control'>
                ...
                <input type="number" name="low" id="low" value={low} onChange={handlelow}/>
                <label htmlFor="high">High</label>
                <input type="number" name="high" id="high" value={high} onChange={handlehigh} />
                <label htmlFor="current-price">Current Price</label>
                <input type="number" name="current-price" id="current-price" value={currentprice} onChange={handleprice}/>
                <label htmlFor="percent">Increase Percent</label>
                <input type="number" name="percent" id="percent" value={percent} onChange={handlepercent} />
                <div>
